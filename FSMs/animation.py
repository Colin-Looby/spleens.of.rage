...
class CharacterFSM(AnimateFSM):
    ...
    airAttack = jumping.to(airAttacking) | airAttacking.to.itself(internal = True) | falling.to(airAttacking) | standing.to(airAttacking) | floored.to.itself(internal = True)
    ...
    floor = floored.to.itself(internal = True) | standing.to(floored) | stun.to(floored)
