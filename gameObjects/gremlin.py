...
class Gremlin(Fighter):
    def __init__(self, position, flip = False):
        super().__init__(position, "gremlin.png", (0, 120, 60, 30))
        ...
        self.UD = VelocityFSM(self, axis=1, bound = (RESOLUTION[1]//2-135, (RESOLUTION[1]//2)+100), accel = 40)
